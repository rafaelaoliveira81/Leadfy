...
import style from './_leadRowActions.module.css';

/**
 * Menu de ações por linha da tabela de leads.
 * @param {object} props
 ...
 */
export function LeadRowActions({ lead, onEdit, onToggleStatus, onDelete }) {
    ...
    <div ref={menuRef} style={{ position: 'relative', display: 'inline-block' }}>
      ...
      {open && (
        <div className={style.menu} role="menu">
          ...
          >
            {lead.isActive ? 'Desativar' : 'Ativar'}
          </button>
          <button
            className={style.menuItem}
            role="menuitem"
